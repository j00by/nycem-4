...
const config = {
    ...
    <a href="https://journals.sagepub.com/doi/10.1111/cico.12283" target="_blank"><sup>3</sup></a><br><br><i class="fa-solid fa-eye" style="color: #0FB1FC"></i> The map features <a href="https://data.cityofnewyork.us/Environment/Sea-Level-Rise-Maps-2050s-100-year-Floodplain-/hbw8-2bah" target="_blank" class="custom-toolkit" data-bs-toggle="tooltip" title="A 100-year floodplain is an area with a 1% chance of flooding annually, used in planning and risk assessments, and does not mean a flood occurs only once every 100 years." style="color: #459cf2; font-weight: bold">2050 sea level rise (100 year floodplain)</a> data highlighting areas at future flood risk. Notably, this analysis does not account for stormwater impacts.`,
            location: {
        ...
        },
        {
            ...
            image: 'img/jds.jpg',
            description: '<br>I extend my heartfelt thanks to the <a href="https://www1.nyc.gov/site/em/about/internship.page" target="_blank">John D. Solomon Fellowship Program</a> for selecting me for the 2023-2024 cohort. My time at NYCEM has been incredibly enriching, both professionally and personally, and I am enthusiastic about the future contributions our collaborative efforts will make to emergency management and public service.<br><br>This project was developed as part of the Advanced GIS Interactive Web Mapping course at New York University, Spring 2024, under the guidance of <a href="https://github.com/chriswhong" target="_blank"> Chris Whong</a>. Special appreciation goes to Ahmad Shaibani, Melissa Umberger, Jacob Ahola, and Rachel Meltzer for their invaluable support and insights.<br><br>Sources: <a href="https://github.com/j00by/nycem-4" target="_blank">Project Repository</a>, <a href="https://github.com/mapbox/storytelling" target="_blank">Mapbox Storytelling Template</a>',
            location: {
                center: [-73.99025, 40.69859],
                zoom: 17,
                pitch: 48.78,
                bearing: 0,
                speed: 1, 
